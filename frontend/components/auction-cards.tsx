...
function AuctionCard({ auction }: { auction: Auction }) {
    ...
    return (
        <Link href={href} className="group block h-full no-underline text-current">
            <Card className="@container/card h-full flex flex-col transition-all hover:-translate-y-0.5 hover:shadow-xs">
